...
namespace WebApp.Controllers
{
    ...
    {
        private readonly Mokshini13012026Context _context;

        public StudentsController(Mokshini13012026Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string sortOrder)
        {
            ...
            var mokshini13012026Context = _context.Students.Include(s => s.Subject);
            return View(await mokshini13012026Context.ToListAsync());
        }
